...
```{r}
if(params$pdf_mode){
  cat("View this resume online with links at _ddstats.blog/resume_")
} else {
  cat("[<i class='fas fa-download'></i> Download a PDF of this CV](https://github.com/ddstats1/resume/resume.pdf)")
}
```
